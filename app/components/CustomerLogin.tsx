              ...
              <div className="flex-1">
               <div className="text-center">
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-6 text-sm text-center text-gray-400">Don't have an account yet? <a href="./customer-signup" className="text-blue-500 focus:outline-none focus:underline hover:underline">Sign up</a>.</p>
                </div>
              </div>
            </div>
          </div>
