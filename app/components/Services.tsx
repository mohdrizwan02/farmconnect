      ...
      <div className="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
          <div className="mx-auto max-w-lg text-center lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
            ...
            Experience seamless communication and transactions with our platform that connects farmers and buyers directly. Benefit from real-time price trends, GPS location tracking, and in-depth statistical analysis to optimize your agricultural business.
            </p>
          ...
          >
              ...
              <h2 className="mt-2 font-bold">Geolocation service</h2>
